//
//  GraphCricketViewController.swift
//  darts
//
...
class GraphCricketViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        values = OperateRealm.getCricket(type: rating_type)
        ...
        if values.count > 0 {
            ...
            aveRating = Rating.cricketRating(score: aveStats, type: rating_type)
